...
int main(int argc, char *argv[])
{
    ...
    while((c = getopt_long(argc, argv, "S:p:hv", long_options, &option_index)) != -1)
    {
        switch(c)
        {
            case 'S':
    ...
    {
        fprintf(stderr, "No service name provided!\n");
        return 1;
    }
    ...
    return diagnose(service_name, manifest_file, coordinator_profile_path, profile);
}
