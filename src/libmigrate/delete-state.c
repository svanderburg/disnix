...
static pid_t delete_state_on_target(SnapshotMapping *mapping, ManifestService *service, Target *target, xmlChar **arguments, unsigned int arguments_length)
{
    ...
    return exec_delete_state((char*)target->client_interface, target_property, (char*)mapping->container, (char*)service->type, (char**)arguments, arguments_length, (char*)service->pkg);
}
