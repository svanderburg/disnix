  ...
  simpleTest {
    ...
    testScript =
      ...
      ''
        ...
        $client->mustSucceed("${env} disnix-ssh-client --target server --activate --type wrapper ${wrapper}");
        
        # Take a snapshot
        $client->mustSucceed("${env} disnix-ssh-client --target server --snapshot --type wrapper ${wrapper}");
        ...
        my $result = $client->mustSucceed("${env} disnix-ssh-client --target server --query-all-snapshots --container wrapper --component ${wrapper} | wc -l");
        ...
        $result = $client->mustSucceed("${env} disnix-ssh-client --target server --query-latest-snapshot --container wrapper --component ${wrapper}");
        my $lastSnapshot = substr $result, 0, -1;
        my $lastResolvedSnapshot = $client->mustSucceed("${env} disnix-ssh-client --target server --resolve-snapshots $lastSnapshot");
        ...
        $result = $client->mustSucceed("${env} disnix-ssh-client --target server --print-missing-snapshots --container wrapper --component ${wrapper} $lastSnapshot wrapper/wrapper/foo | wc -l");
        ...
        $result = $client->mustSucceed("${env} disnix-ssh-client --target server --export-snapshots ".(substr $lastResolvedSnapshot, 0, -1));
        ...
        $client->mustSucceed("${env} disnix-ssh-client --target server --clean-snapshots --container wrapper --component ${wrapper}");
        $result = $client->mustSucceed("${env} disnix-ssh-client --target server --query-all-snapshots --container wrapper --component ${wrapper} | wc -l");
        ...
        $lastResolvedSnapshot = $client->mustSucceed("${env} disnix-ssh-client --target server --resolve-snapshots $lastSnapshot");
        $result = $server->mustSucceed("cat ".(substr $lastResolvedSnapshot, 0, -1)."/state");
        ...
        $client->mustSucceed("${env} disnix-ssh-client --target server --import-snapshots --localfile --container wrapper --component wrapper ".(substr $tmpDir, 0, -1));
        ...
        # uploaded state (2)
        $client->mustSucceed("${env} disnix-ssh-client --target server --restore --type wrapper ${wrapper}");
        ...
        $client->mustSucceed("${env} disnix-ssh-client --target server --clean-snapshots --container wrapper --component ${wrapper} --keep 0");
        $result = $client->mustSucceed("${env} disnix-ssh-client --target server --query-all-snapshots --container wrapper --component ${wrapper} | wc -l");
